...
public class RegisterControllerUnitTest {
	...
	private String correctReturn = "register";
	...
	public void testDisplayRegisterPage() {
		...
		assertThat(retValue, equalTo(correctReturn));
	}
	
	@Test
	public void testRegisterUser() {
		assertThat(registerController.registerUser(new User()), equalTo(correctReturn));
	}
